...
class IQARegression(nn.Module):
    ...
    def forward(self, mask_inputs, feat_dis_org, feat_dis_scale_1):
        ...
        enc_outputs = self.transformer(mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed)
...
class Transformer(nn.Module):
    ...
    def forward(self, mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed):
...
class Encoder(nn.Module):
    ...
    def forward(self, mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed):
        ...
        inputs_embed = torch.cat((feat_dis_org_embed, feat_dis_scale_1_embed), dim=1)
