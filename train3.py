...
from trainer import smViT_train_epoch, smViT_val_epoch, nm_train_epoch, nm_val_epoch
...
def ViT_EPI():
    ...
    # train & validation
    for epoch in range(start_epoch, config.n_epoch):
        loss, rho_s, rho_p = nm_train_epoch(config, epoch, model_transformer, model_backbone, train_loader, optimizer,
                                            criterion, scheduler)
