...
from utils.util import RandShuffle, MS_Normalize, MS_ToTensor
from trainer import ms_train_epoch, ms_val_epoch
...
def SAI():
    config = Config({
        ...
        'gpu_id': "1",
        'num_workers': 8,
        'train_name': 'SAI-MUSIQ-25',

        # dataset
        'db_name': 'WIN5-SAI-25',
        'txt_filename': './IQA_list/WIN5-SAI-25.txt',
        ...
        'snap_path': './MUSIQ_SAI_25_weights',
        'checkpoint': './MUSIQ_SAI_25_weights/epoch50.pth',
    ...
    if config.db_name == 'WIN5-SAI-25':
        from data.WIN5_SAI_2 import IQADataset
